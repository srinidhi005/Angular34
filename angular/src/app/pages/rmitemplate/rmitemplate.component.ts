...
@Component({
  selector: 'app-rmitemplate',
    templateUrl: './rmitemplate.component.html',
      styleUrls: ['./rmitemplate.component.scss']
      })
      export class RmitemplateComponent implements OnInit {      
	...
	$("#myTableB tr:first").after("<tr><td>"+companyName+"</td></tr>");
	$("#myTableB tr:last").after('<tr></tr><tr><td style="font-weight: bold;">RMI/INSIGHTS</td></tr>');
	const ws: xlsx.WorkSheet = xlsx.utils.table_to_sheet(this.epltable.nativeElement);
	$("#myTableB tr:eq(1)").remove();
	$("#myTableB tr:last").remove();
...
var dt = new Date();
	...
	var res = doc.autoTableHtmlToJson(document.getElementById('myTableB'));
